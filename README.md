...
```powershell
.\scripts\package-module.ps1 -Version 0.14.0 -Configuration Release
Import-Module .\artifacts\module\SyntheticEnterprise.PowerShell\0.14.0\SyntheticEnterprise.PowerShell.psd1 -Force
```
...
```powershell
$evidenceRoot = [IO.Path]::GetFullPath((Join-Path ([IO.Path]::GetTempPath()) ('DataGenReleaseEvidence-v0.14.0-' + [Guid]::NewGuid().ToString('N'))))
