...
Use this to list the first-class scenario archetype catalog. It can also surface plugin-aware contributions when plugin roots and enabled capabilities are supplied.
