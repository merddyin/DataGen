...
If you plan to refresh the same generated lab repeatedly, continue to [Repeatable Lab Runs](/walkthroughs/repeatable-lab-runs) for the fixed scenario, seed, snapshot, export, and comparison workflow.
