...
5. Review [What’s New](/about/whats-new) for the latest platform changes and release notes.
6. Read the [Plugin Architecture guide](/sdk/plugin-architecture) before extending the dataset.
