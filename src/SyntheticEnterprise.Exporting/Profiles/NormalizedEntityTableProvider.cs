        ...
        return new object[]
        {
            ...
            new EntityTableDescriptor<PolicySettingRecord>
            {
                ...
                RowProjector = setting => new Dictionary<string, object?>
                {
                    ...
                    ["policy_path"] = setting.PolicyPath,
            ...
            new EntityTableDescriptor<DirectoryAccount>
            {
                ...
                RowProjector = account => new Dictionary<string, object?>
                {
                    ...
                    ["last_logon"] = account.LastLogon,
                    ["when_created"] = account.WhenCreated,
                    ["when_modified"] = account.WhenModified,
            ...
            new EntityTableDescriptor<EndpointManagementObservation>
            {
                ...
                RowProjector = observation => new Dictionary<string, object?>
                {
                    ...
                    ["is_current"] = observation.IsCurrent,
                    ["superseded_by_observation_id"] = observation.SupersededByObservationId,
