# Run this in an administrative PowerShell prompt to install the DataGen PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/merddyin/DataGen")

# Some general variables
$ModuleName = 'DataGen'
$DownloadURL = 'https://github.com/merddyin/DataGen'
